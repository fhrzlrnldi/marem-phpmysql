...
class negara extends db
{
    ...
    public function store($id_negara, $nama_negara)
    {
    ...
    public function update($id_negara, $nama_negara)
    {
        $data = $this->db->prepare("UPDATE negara SET nama_negara = ? WHERE id_negara = ?");

        $data->bindParam(1, $nama_negara);
    ...
    {
        $data = $this->db->prepare("DELETE FROM negara WHERE id_negara = ?");
        $data->bindParam(1, $id_negara);
        try
        {
            $result = $data->execute();
...
if(isset($_POST['submit'])){
    ...
    $data->store($id_negara, $nama_negara);
...
if(isset($_POST['update'])){
    ...
    $id_negara = $_POST ['id_negara'];
    $nama_negara = $_POST ['nama_negara'];
    $data->update($id_negara, $nama_negara);
    $_SESSION["sukses"] = 'Data Berhasil Disimpan';
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Data Tabel Negara</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="barang.php">Data Tabel Negara</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Tabel Negara</h5>
           
              <!-- Bordered Table -->
              <div class="container-fluid my-4">

<div class="d-flex justify-content-end">
    <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#insert">Insert Data Negara</a>
</div>
<div class="modal fade" id="insert" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Insert Data Negara</h5>
        ...
        <div class="modal-body">
            ...
            <div class="row d-flex align-items-center justify-content-between my-3">
                ...
                <div class="col-lg-7">
                    <input required class="form-control" type="text" name="id_negara" placeholder="ID Negara">
                </div>
            </div>

            <div class="row d-flex align-items-center justify-content-between my-3">
                <div class="col-5">Nama Negara</div>
                <div class="col-lg-7">
                    <input required class="form-control" type="text" name="nama_negara" placeholder="Nama Negara">
                </div>
            </div>
    ...
    <thead>
                ...
                <?php foreach ($data->show() as $value): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <button class="btn btn-info mx-1" data-bs-toggle="modal" data-bs-target="#update<?php echo $value['id_negara']; ?>">Update</button>
                                                    <button class="btn btn-sm btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#delete<?php echo $value['id_negara']; ?>">delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="update<?php echo $value['id_negara']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Update Data Negara</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST">
                                                <input required class="form-control" type="hidden" name="id_negara" value="<?php echo $value['id_negara'] ?>">

                                                <div class="row d-flex align-items-center justify-content-between my-3">
                                                    <div class="col-5">Nama Negara</div>
                                                    <div class="col-lg-7">
                                                        <input required class="form-control]oiuyt541`" type="text" name="nama_negara"  value="<?php echo $value['nama_negara'] ?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade" id="delete<?php echo $value['id_negara']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Delete Data Negara</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST">
