...
class jabatan extends db
{
    ...
    public function store($id_jabatan, $nama_jabatan)
    {
        $data = $this->db->prepare("INSERT INTO jabatan (id_jabatan, nama_jabatan) VALUES (?, ?)");
        $data->bindParam(1, $id_jabatan);
        $data->bindParam(2, $nama_jabatan);
        try
        {
            $result = $data->execute();
        }
    ...
    public function update($id_jabatan, $nama_jabatan)
    {
        $data = $this->db->prepare("UPDATE jabatan SET nama_jabatan = ? WHERE id_jabatan = ?");

        $data->bindParam(1, $nama_jabatan);
    ...
    {
        $data = $this->db->prepare("DELETE FROM jabatan WHERE id_jabatan = ?");
        $data->bindParam(1, $id_jabatan);
        try
        {
            $result = $data->execute();
...
if(isset($_POST['submit'])){
    ...
    $data->store($id_jabatan, $nama_jabatan);
...
if(isset($_POST['update'])){
    ...
    $id_jabatan = $_POST ['id_jabatan'];
    $nama_jabatan = $_POST ['nama_jabatan'];
    $data->update($id_jabatan, $nama_jabatan);
    $_SESSION["sukses"] = 'Data Berhasil Disimpan';
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="jabatan.php">Jabatan Maremn</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Jabatan Marem</h5>
           
              <!-- Bordered Table -->
              <div class="container-fluid my-4">

                    <div class="d-flex justify-content-end">
                        <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#insert">Insert Data Jabatan</a>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row d-flex align-items-center justify-content-between my-3">
                                    ...
                                    <div class="col-lg-7">
                                        <input required class="form-control" type="text" name="id_jabatan" placeholder="ID">
                                    </div>
                                </div>
                                <div class="row d-flex align-items-center justify-content-between my-3">
                                    <div class="col-5">Jabatan</div>
                                    <div class="col-lg-7">
                                        <input required class="form-control" type="text" name="nama_jabatan" placeholder="Jabatan">
                                    </div>
                                </div>
    ...
    <thead>
                ...
                <?php foreach ($data->show() as $value): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <button class="btn btn-sm btn-warning mx-1" data-bs-toggle="modal" data-bs-target="#update<?php echo $value['id_jabatan']; ?>">Update</button>
                                                    <button class="btn btn-sm btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#delete<?php echo $value['id_jabatan']; ?>">delete</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <div class="modal fade" id="update<?php echo $value['id_jabatan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Update Data Jabatan</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST">
                                                <input required class="form-control" type="hidden" name="id_jabatan" value="<?php echo $value['id_jabatan'] ?>">


                                                <div class="row d-flex align-items-center justify-content-between my-3">
                                                    <div class="col-5">Jabatan</div>
                                                    <div class="col-lg-7">
                                                        <input required class="form-control" type="text" name="nama_jabatan"  value="<?php echo $value['nama_jabatan'] ?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade" id="delete<?php echo $value['id_jabatan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Delete Data Jabatan</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="POST">
